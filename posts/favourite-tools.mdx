---
    ...
    date: "3/14/2022"
    preview: "I've compiled a list of all of my favourite tools that I've used over the years, and turned it into a blog post!"
    image: "/posts/favourite-tools.png"
    end: "Please let me know if you like these tools, or if you have anything else to add, and once again, thanks for reading!"
---
